...
<header class="header_chart">
	<img
		src="${pageContext.request.contextPath }/resources/imges/chart_login_logo.png"
		alt="로고사진" width="60" />
	<div id="title">
		<h1>요일</h1>
	</div>
	<div id="title2">
		<h4>내 가족의 행복과 건강을 위한 요양일지</h4>
	</div>
	<c:choose>
		...
		<c:otherwise>
			...
			<div>
				<button class="btn mypage">내 정보</button>
			</div>
			<div>
				<button class="btn list">치료일지</button>
			</div>
			<div>
				<button class="btn health">건강일지</button>
			</div>
		</c:otherwise>
	</c:choose>
	<script>
